...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { artform: @art.artform, description: @art.description, name: @art.name, price: @art.price, sold: @art.sold } }, as: :json
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { artform: @art.artform, description: @art.description, name: @art.name, price: @art.price, sold: @art.sold } }, as: :json
    assert_response 200
  end
